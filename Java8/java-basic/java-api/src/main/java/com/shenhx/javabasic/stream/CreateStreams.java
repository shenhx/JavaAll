package com.shenhx.javabasic.stream;
...
public class CreateStreams {
	...
	public void demo1() {
		...
		List<Integer> numberList = Arrays.asList(1, 2, 3, 4, 3, 4, 6, 7, 5);
		List<Integer> squaresList = numberList.stream().map(i -> i * i).distinct().collect(Collectors.toList());
		squaresList.forEach(System.out::println);
		System.out.println("");

		List<String> stringList = Arrays.asList("a", "abc", "bc", "", "ddeg");
		...
		List<String> stringList2 = Arrays.asList("a", "abc", "bc", "", "ddeg");
		long count3 = stringList2.parallelStream().filter(s -> s.isEmpty()).count();
